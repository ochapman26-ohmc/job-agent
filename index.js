...
async function searchIndeedJobs(query) {
  ...
  const response = await client.beta.messages.create({
    ...
    messages: [
      {
        role: "user",
        content: `Search Indeed for jobs matching: "${query}" in Sydney, Australia. Full-time roles only. List all results you find.`,
      },
    ],
    mcp_servers: [
